 ...
 * @author alejandro
 */
public class subirSolucion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response
        ...
        if (userName != null && id != null) {
            ...
            File fichero = new File(realpath +"solucionesCanvas.xml");          
            if (fichero.isFile()) {
                try {
                    ...
                    for (int ix = 0; ix < list.size(); ix++) {
                        ...
                        if (e.getAttributeValue("pregunta").equals(ejercicio)) {
                            ...
                            xmlOutput.output(doc, new FileWriter(realpath + "solucionesCanvas.xml"));
                            break;
                        }
                    }
                    if (i == 0) {
