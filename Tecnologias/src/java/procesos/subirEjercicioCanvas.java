 ...
 * @author alejandro
 */
public class subirEjercicioCanvas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response
        ...
        String lectura = (String) session.getAttribute("lectura");
        ...
        if (userName != null && id != null) {
            ...
            File fichero = new File(realpath + "ejercicioCanvas.xml");
            ...
            if (fichero.isFile()) {
                try {
                    ...
                    if (i == 0) {
                        ...
                        ejemplo.setAttribute("lectura", lectura);
                        ejemplo.setAttribute("pregunta", pregunta);                        
                        XMLOutputter xmlOutput = new XMLOutputter();
                        xmlOutput.setFormat(Format.getPrettyFormat());
                        //sobreescribimos el archivo con los nuevos datos
                        xmlOutput.output(doc, new FileWriter(realpath + "ejercicioCanvas.xml"));
