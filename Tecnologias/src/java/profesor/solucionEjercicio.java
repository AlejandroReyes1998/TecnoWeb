...
public class solucionEjercicio extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null && id != null) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Subir Solución</title>");
            ...
            out.println("<div class='form-prof-top'><h4>Subir Solución</h4></div>");
            out.println("<form method='get' action='crearSolucionCanvas'>");
