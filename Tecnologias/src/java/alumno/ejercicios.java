...
public class ejercicios extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null && id != null) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Seleccion de ejercicio</title>");
            ...
            out.println("<form method='get' action='resolverEjercicio'>");
            ...
            for (Element ejercicio : archivoXML.getCanvas()) {
                ...
                if (resueltos.indexOf(ejercicio.getAttributeValue("nombre"))==-1) {
                    ...
                    if (ejercicio.getAttributeValue("grupo").equals(grupo)) {
                        out.println("<option value='" + ejercicio.getAttributeValue("nombre") + "'>" + ejercicio.getAttributeValue("nombre") + "</option>");
                    }
                }
            }
            out.println("</select>");
            out.println ("</div>");
            out.println ("<div class='form-group'>");
            out.println("<button class='btn form-control btn-info'>Solicitar</button>");
            out.println ("</div>");
            out.println("<div class='form-group'>");
